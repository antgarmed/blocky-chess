...
| [`default-anchored-self-play`](default-anchored-self-play/EXPERIMENT.md) | Contemporary self-play plus a small `Default` anchor | Design draft; implementation and calibration pending |
